...
class Costumer( models.Model ):
    ...
    email = models.EmailField( max_length=254, unique=True )
    nipt = models.CharField( max_length=10, unique=True )
    agent = models.ForeignKey( Agent, on_delete=models.CASCADE, related_name='costumeragent' )
    is_deleted = models.BooleanField( default=False )
...
class PurchaseBillDetails( models.Model ):
    ...
    supplier = models.ForeignKey( Supplier, on_delete=models.CASCADE, related_name='purchasedetailsupplier' )
...
class SaleBill( models.Model ):
    billno = models.AutoField( primary_key=True )
    time = models.DateTimeField( auto_now=True )
    costumer = models.ForeignKey( Costumer, on_delete=models.CASCADE, related_name='salecostumer' )
    agent = models.ForeignKey( Agent, on_delete=models.CASCADE, related_name='saleagent' )
...
class SaleBillDetails( models.Model ):
    ...
    total = models.CharField( max_length=50, blank=True, null=True )
    costumer = models.ForeignKey( Costumer, on_delete=models.CASCADE, related_name='costumersale' )
    agent = models.ForeignKey( Agent, on_delete=models.CASCADE, related_name='agentsale' )
